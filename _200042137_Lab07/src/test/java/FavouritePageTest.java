...
public class FavouritePageTest {
    ...
    public void TestFavourite() throws InterruptedException {
        ...
        WebElement favoritesButton = driver.findElement(By.cssSelector("a[data-test='nav-favorites']"));
        ...
        Assert.assertEquals("https://practicesoftwaretesting.com/#/account/favorites", currentUrl);
